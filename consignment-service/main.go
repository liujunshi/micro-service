...
import (
	...
	"log"
	pb "micro-service/consignment-service/proto/consignment"
	"net"
)
...
func (repo *Repository) Create(consignment *pb.Consignment) (*pb.Consignment, error) {
	...
	fmt.Println("增加货物 consignment ",consignment)
...
func (s *service) GetConsignments(ctx context.Context, in *pb.GetRequest) (*pb.Response, error) {
	allCons := s.repo.GetAll()
	resp := &pb.Response{Consignments: allCons}
	return resp, nil
}
